...
날씨, 취향을 고려하여 사용자 보유한 의상 조합 추천 기능 및 오늘의 착장(OOTD) 피드 게시, 팔로우, 채팅 등의 소셜 기능을 갖춘 LLM 기반 추천 서비스를 개발하였습니다.
